...
@section('content')
    ...
    <div class="container-xxl container-p-y py-4">
        <div class="misc-wrapper">
            ...
            <div class="mt-12">
                <img src="{{ asset('vendor/koneko-vuexy-admin/img/illustrations/page-misc-launching-soon.png') }}" alt="page-misc-launching-soon" width="263" class="img-fluid">
            </div>
        </div>
    </div>
    <div class="container-fluid misc-bg-wrapper">
        <img src="{{ asset('vendor/koneko-vuexy-admin/img/illustrations/bg-shape-image-'.$configData['style'].'.png') }}" height="355" alt="page-misc-coming-soon" data-app-light-img="illustrations/bg-shape-image-light.png" data-app-dark-img="illustrations/bg-shape-image-dark.png">
    </div>
    <!-- /Coming soon -->
@endsection
