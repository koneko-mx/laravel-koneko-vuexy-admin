...
@vite([
  'vendor/koneko/laravel-koneko-vuexy-admin/resources/assets/vendor/libs/bs-stepper/bs-stepper.scss',
  'vendor/koneko/laravel-koneko-vuexy-admin/resources/assets/vendor/libs/bootstrap-select/bootstrap-select.scss',
...
@vite([
  'vendor/koneko/laravel-koneko-vuexy-admin/resources/assets/vendor/libs/cleavejs/cleave.js',
  'vendor/koneko/laravel-koneko-vuexy-admin/resources/assets/vendor/libs/cleavejs/cleave-phone.js',
  'vendor/koneko/laravel-koneko-vuexy-admin/resources/assets/vendor/libs/bs-stepper/bs-stepper.js',
...
@push('page-script')
@vite([
  'vendor/koneko/laravel-koneko-vuexy-admin/resources/js/auth/pages-auth-multisteps.js'
])
@endpush
...
<div class="authentication-wrapper authentication-cover authentication-bg">
  ...
  <div class="authentication-inner row">
    ...
    <div class="d-none d-lg-flex col-lg-4 align-items-center justify-content-center p-5 auth-cover-bg-color position-relative auth-multisteps-bg-height">
      <img src="{{ asset('vendor/koneko-vuexy-admin/img/illustrations/auth-register-multisteps-illustration.png') }}" alt="auth-register-multisteps" class="img-fluid" width="280">

      <img src="{{ asset('vendor/koneko-vuexy-admin/img/illustrations/auth-register-multisteps-shape-'.$configData['style'].'.png') }}" alt="auth-register-multisteps" class="platform-bg" data-app-light-img="illustrations/auth-register-multisteps-shape-light.png" data-app-dark-img="illustrations/auth-register-multisteps-shape-dark.png">
    </div>
    <!-- /Left Text -->
