                    ...
                    <div class="col-xl-12">
                        <div class="nav-align-left nav-tabs-shadow mb-6">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                @if (($is_customer) && $this->tipo_persona != Koneko\KonekoVuexyAdmin\Models\User::TIPO_RFC_PUBLICO)
                                    <li class="nav-item" role="presentation">
                                ...
                                @endif
                                @if (($is_prospect || $is_customer || $is_provider) && $this->tipo_persona != Koneko\KonekoVuexyAdmin\Models\User::TIPO_RFC_PUBLICO)
                                    <li class="nav-item" role="presentation">
                                ...
                                @endif
                                @if (($is_customer || $is_provider) && $this->tipo_persona != Koneko\KonekoVuexyAdmin\Models\User::TIPO_RFC_PUBLICO)
                                    <li class="nav-item" role="presentation">
