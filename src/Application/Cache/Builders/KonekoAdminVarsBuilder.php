...
namespace Koneko\KonekoVuexyAdmin\Application\Cache\Builders;

use Koneko\KonekoVuexyAdmin\Application\UX\ImageHandler\WebAdminImageHandler;
...
class KonekoAdminVarsBuilder
{
    ...
    protected function buildFaviconPaths(array $settings): array
    {
        ...
        $favicon_default = '../vendor/koneko-vuexy-admin/img/logo/koneko-04.png';
    ...
    {
        $logo_default = '../vendor/koneko-vuexy-admin/img/logo/koneko-04.png';
