...
namespace Koneko\KonekoVuexyAdmin\Application\Config\Manager;
...
use Koneko\KonekoVuexyAdmin\Application\Cache\Builders\SettingCacheKeyBuilder;
use Koneko\KonekoVuexyAdmin\Application\Traits\System\Context\{HasBaseContext, HasConfigContextValidation};
...
final class KonekoConfigManager implements ConfigRepositoryInterface
{
    ...
    public function getScopeModel(): ?\Illuminate\Database\Eloquent\Model
    {
        ...
        return ($this->context['scope'] && $this->context['scope_id'])
            ? \Koneko\KonekoVuexyAdmin\Application\Settings\Registry\ScopeRegistry::getModelInstance(
                $this->context['scope'],
