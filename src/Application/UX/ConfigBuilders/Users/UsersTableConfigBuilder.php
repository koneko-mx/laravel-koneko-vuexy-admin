...
namespace Koneko\KonekoVuexyAdmin\Application\UX\ConfigBuilders\Users;

use Koneko\KonekoVuexyAdmin\Models\User;
use Illuminate\Contracts\Database\Query\Builder;
use Illuminate\Support\Facades\DB;
use Koneko\KonekoVuexyAdmin\Support\Builders\Table\AbstractTableConfigBuilder;
use Koneko\KonekoVuexyAdmin\Support\Traits\ConfigBuilder\HandlesStaticRegistryMerge;
    ...
    public static function getIndexColumns(): array
    {
        $local = [
            ...
            DB::raw("(SELECT GROUP_CONCAT(`roles`.`name` SEPARATOR '|') AS `roles`
                ...
                WHERE`model_has_roles`.`model_id` = users.id AND `model_has_roles`.`model_type` = 'Koneko\\\\KonekoVuexyAdmin\\\\Models\\\\User'
