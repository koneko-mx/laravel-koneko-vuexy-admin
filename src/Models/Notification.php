...
use Carbon\Carbon;
use Koneko\KonekoVuexyAdmin\Database\Factories\NotificationFactory;
use Koneko\KonekoVuexyAdmin\Support\Traits\Audit\{HasEmitter,HasUpdater,HasUser};

/**
 * Modelo de notificaciones internas para KonekoVuexyAdmin y Website.
 *
 * @property int $id
