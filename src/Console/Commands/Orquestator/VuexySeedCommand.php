...
namespace Koneko\KonekoVuexyAdmin\Console\Commands\Orquestator;

use Illuminate\Console\Command;
use Koneko\KonekoVuexyAdmin\Application\Seeding\SeederOrchestrator;
...
class VuexySeedCommand extends Command
{
    ...
    protected function qualifySeederClass(string $class): string
    {
        ...
        $namespaces = [
            'Koneko\\KonekoVuexyAdmin\\Database\\Seeders\\',
