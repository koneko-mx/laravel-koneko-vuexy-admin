...
<p align="center">
    ...
    <a href="https://packagist.org/packages/koneko/laravel-koneko-vuexy-admin"><img src="https://img.shields.io/packagist/v/koneko/laravel-koneko-vuexy-admin" alt="Versión estable"></a>
    <a href="https://packagist.org/packages/koneko/laravel-koneko-vuexy-admin"><img src="https://img.shields.io/packagist/l/koneko/laravel-koneko-vuexy-admin" alt="Licencia"></a>
    <a href="https://github.com/koneko-mx/laravel-koneko-vuexy-admin"><img src="https://img.shields.io/github/issues/koneko-mx/laravel-koneko-vuexy-admin" alt="Issues"></a>
</p>
...
```bash
composer require koneko/laravel-koneko-vuexy-admin
```
...
"repositories": {
    "koneko/laravel-koneko-vuexy-admin": {
        "type": "vcs",
        "url": "https://github.com/koneko-mx/laravel-koneko-vuexy-admin"
    }
}
```

```bash
composer require koneko/laravel-koneko-vuexy-admin:@dev
```
...
* `koneko/laravel-koneko-vuexy-admin` (este repo)
* `koneko/laravel-koneko-website-admin`
* `koneko/laravel-koneko-layout-porto`
