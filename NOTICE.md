...
This software includes portions created and maintained by Koneko Soluciones Tecnológicas. All rights reserved.

Portions of this project integrate third-party code, including but not limited to:

* Vuexy Admin Template by PIXINVENT ([https://themeforest.net/item/vuexy-vuejs-html-laravel-admin-dashboard-template/23328599](https://themeforest.net/item/vuexy-vuejs-html-laravel-admin-dashboard-template/23328599)) — a commercial product. **A valid license must be acquired** to use it legally in production.
* Laravel and open-source packages as specified in `composer.json`, each under their own respective licenses.

The use of this software implies full acceptance of the LICENSE file and compliance with the restrictions outlined therein.

This NOTICE file is part of the licensing documentation and must be included with all copies or substantial portions of the Software.

For more information, please visit: [https://koneko.mx](https://koneko.mx) or contact: [opensource@koneko.mx](mailto:opensource@koneko.mx)
